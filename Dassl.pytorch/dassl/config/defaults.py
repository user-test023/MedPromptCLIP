...
# 在INPUT配置部分添加新的参数
_C.INPUT.BRIGHTNESS_ALPHA = 1.5  # 对比度增强因子
_C.INPUT.BRIGHTNESS_BETA = 30  # 亮度调整值
_C.INPUT.BRIGHTNESS_P = 0.5  # 应用亮度增强的概率

_C.INPUT.BINARIZE_BLOCK_SIZE = 11  # 自适应二值化的邻域大小
_C.INPUT.BINARIZE_C = 2  # 自适应二值化的常数
_C.INPUT.BINARIZE_P = 0.5  # 应用自适应二值化的概率

_C.INPUT.OTSU_P = 0.5  # 应用Otsu二值化的概率
###########################
# Dataset
###########################
_C.DATASET = CN()
